...
/**
 * Servlet implementation class ActivePostController
 */
@WebServlet("/adminpostactive")
public class ActivePostController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ActivePostController() {
        super();

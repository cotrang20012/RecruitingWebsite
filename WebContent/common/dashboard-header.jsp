				...
				<c:when test="${user!=null }">
					<div class="dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
							...
							<a class="dropdown-item" href="<c:out value='changepw' />"><i class="dw dw-help"></i> Đổi mật khẩu</a> <a class="dropdown-item" href="<c:out value='logout' />"><i class="dw dw-logout"></i> Log Out</a>
						</div>
					</div>
				</c:when>
				<c:otherwise>

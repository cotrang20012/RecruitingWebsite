					...
					<div class="dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        	...
                        	<c:when test="${acc.typeUser=='EMPLOYEE' }">
                        		<a class="dropdown-item" href="${pageContext.request.contextPath}/employee/profile"><i class="dw dw-user1"></i> Profile</a>
                        	</c:when>
                        	<c:when test="${acc.typeUser=='EMPLOYER' }">
                        		<a class="dropdown-item" href="${pageContext.request.contextPath}/employer/profile"><i class="dw dw-user1"></i> Profile</a>
                        	</c:when>
                        	<c:otherwise>
                        		<a class="dropdown-item" href="${pageContext.request.contextPath}/admin/profile"><i class="dw dw-user1"></i> Profile</a>
                        	</c:otherwise>
                        </c:choose>

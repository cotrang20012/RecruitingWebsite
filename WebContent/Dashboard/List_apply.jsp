									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" href ="<c:url value='/employer/viewprofile'/>"><i class="dw dw-eye"></i> View</a>
												<a class ="dropdown-item" href ="<c:url value='/employer/sendmail?postId=${Post.HexStringId() }&accountId=${item.accountID}'/>"><i class="dw dw-eye"></i>Gửi mail thông báo trúng tuyển</a>

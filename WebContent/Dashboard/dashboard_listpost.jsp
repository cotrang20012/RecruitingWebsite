                    ...
                    <li class="row list-group-item">
                        <div class="col-10">
                            <h3 class="list-group-item-heading">
                                Amazing Item
                                <span class="badge badge-danger px-3 rounded-pill font-weight-normal">Đang tuyển</span>
                            </h3>
                            <p> Lập trình C# <br/> <a href="#">Danh sách người ứng tuyển</a>
                            </p>
                        </div>
                        <div class="col-2">
                            <a href="#" class="btn btn-primary col-10">Chỉnh sửa</a><br>
                            <a href="#" class="btn btn-primary col-10">Dừng tuyển</a><br>
